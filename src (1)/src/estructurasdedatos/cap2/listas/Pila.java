...
public class Pila {
    ...
    public EjercicioTiposDeDatosPersona dato;
    ...
    public void apilar(String nombre, String telefono, String cedula, String direccion) {
        ...
        EjercicioTiposDeDatosPersona newper = new EjercicioTiposDeDatosPersona();
        newper.setCedula(cedula);
        newper.setNombre(nombre);
        newper.setTelofono(telefono);
    ...
    public void listar() {
        if (!(tope == null)) {
            ...
            while (aux != null) {
                ...
                System.out.println("[" + aux.getDato().getNombre() + " " + aux.getDato().getTelofono() + " "
    ...
    public void desapilar() {
        if (esVacia()) {
            ...
            System.out.println("eliminado" + "[" + tope.getDato().getNombre() + " " + tope.getDato().getTelofono() + " "
