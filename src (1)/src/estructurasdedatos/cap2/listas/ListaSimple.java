...
public class ListaSimple {
  ...
  public void CrearLista (){ // aqui creo una lista con cabeza y cola 
 ...
 public void InserDardato (int dato){ // aqui creamos el nuevo nodo y 
    NodoSimple nnodo= new NodoSimple(); //le asignamos el valor de el dato, luego  
